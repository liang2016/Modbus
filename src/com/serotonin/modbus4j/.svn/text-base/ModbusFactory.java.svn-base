...
public class ModbusFactory {
    ...
    // Modbus requests
    //
    public ModbusRequest createReadRequest(int slaveId, int range, int offset, int length)//range功能号,需要添加一个时间
        ...
        //这里加一个88的功能(88功能要包含time)
        //if(range == RegisterRange.HOLDING_REGISTER_88)
        	//return new ReadHoldingRegisters_88Request(slaveId, offset, length,time);
