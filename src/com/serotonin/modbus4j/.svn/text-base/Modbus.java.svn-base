...
public class Modbus {
    ...
    public static final int DEFAULT_MAX_READ_REGISTER_88_COUNT = 10000;
    ...
    private int maxReadRegisterCount_88 = DEFAULT_MAX_READ_REGISTER_88_COUNT;
    ...
    public int getMaxReadCount(int registerRange) {
        ...
        case RegisterRange.HOLDING_REGISTER_88:
        	return maxReadRegisterCount_88;
        }
        return -1;
    }
    ...
    public void validateNumberOfRegisters_88(int registers) throws ModbusTransportException {
        if (registers < 1 || registers > maxReadRegisterCount_88)
            throw new ModbusTransportException("Invalid number of registers: " + registers);
    }
    ...
    public int getMaxReadRegisterCount_88() {
		return maxReadRegisterCount_88;
	}

	public void setMaxReadRegisterCount_88(int maxReadRegisterCount_88) {
		this.maxReadRegisterCount_88 = maxReadRegisterCount_88;
	}
